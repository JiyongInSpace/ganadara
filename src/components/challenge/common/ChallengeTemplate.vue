    ...
    >
        ...
        <template v-slot:bottom>
            <div class="background-secondary py-10 px-4">
                ...
                <div class="d-flex ga-2-5 text-t-sm mb-5">
                    <div>
                        Terms of Service
                    </div>
                ...
                <div class="text-t-xs text-text-quaternary">
                    Copyright 2016. CRATES CO.,LTD. All rights reserved.
                </div>
            </div>
